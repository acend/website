...
{{< figure
  process="fill 1600x800"
  lqip="21x webp q20"
  loading="eager"
  fetchpriority="high" 
  src="images/journal/test/TK_BlogPost_SommerWorkshop2024_3.jpg"
...
{{< svg "assets/images/journal/test/kafka-kraft-migration-zookeeper-architecture.svg" >}}
...
{{< slideshow >}}
{{< slider-img src="images/journal/test/TK_BlogPost_SommerWorkshop2024_3.jpg" caption="Wanderung von Sunnbüel zum Hotel Schwarenbach" >}}
{{< slider-img src="images/journal/test/TK_BlogPost_SommerWorkshop2024_2.jpg" caption="Bergsee vor dem Hotel Schwarenbach" >}}
{{< slider-img src="images/journal/test/TK_BlogPost_SommerWorkshop2024_4.jpg" caption="Aussicht vom Gemmi-Pass" >}}
{{< /slideshow >}}
...
{{< svg "assets/images/journal/test/kafka-kraft-migration-kraft-roles.svg" >}}
...
{{< svg "assets/images/journal/test/kafka-kraft-migration-timeline.svg" >}}
...
{{< svg "assets/images/journal/test/kafka-kraft-migration-releases.svg" >}}
...
{{< svg "assets/images/journal/test/kafka-kraft-migration-states.svg" >}}
