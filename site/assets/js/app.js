...
import trainings from "./assets/js/views/trainings";
import about from "./assets/js/views/about";
import faq from "./assets/js/views/faq";

import { map, lerp, getMousePos, calcWinsize, getRandomNumber } from './assets/js/utils/utils';
